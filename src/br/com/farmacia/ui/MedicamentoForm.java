...
public class MedicamentoForm extends FormularioUI {
	...
	private JTextField numero_msTxt, nomeTxt, labTxt, codigo_barrasTxt, loteTxt, 
	concentracaoTxt, valor_compraTxt, valor_vendaTxt, 
	quantidadeTxt;
	 ...
	 * @param medicamento Medicamento para ser editado ou um vazio, caso seja um novo
	 * cadastro
	 * @param e True se for uma edição ou False, caso contrário
	 * */
	...
	private void prepararCampos() {
		...
		concentracaoTxt = new JTextField();
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Pronto":	// Validar mandar pro banco
			...
			double valor_compra, valor_venda, concentracao;
